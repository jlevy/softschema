...
# Test: pure YAML reaches the Pydantic semantic layer
...
```console
$ softschema validate examples/movie_page/spirited-away.yaml --profile pure-yaml --model examples.movie_page.model:MoviePage
{
  "contract": {
    "envelope_key": null,
    "id": "example.movies:MoviePage/v1",
