...
```console
$ $SOFTSCHEMA validate tests/golden/fixtures/execution-accepted.md --model packages/typescript/test/fixtures/execution-model.mjs:Sample --require structural --require semantic
{
  "contract": {
    "envelope_key": "sample",
    "id": "example:Sample/v1",
