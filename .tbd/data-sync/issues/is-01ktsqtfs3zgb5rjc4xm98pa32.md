...
- Phrase the sidecar guarantee as content-identical with equal schema_sha256 (the YAML bytes differ), at both mentions.
- Shorten the duplicated full movie artifact to a fragment plus a link to examples/ (it is reproduced in README, guide, and spec).
Refs review README F1.1/F6.1, F5.2.
