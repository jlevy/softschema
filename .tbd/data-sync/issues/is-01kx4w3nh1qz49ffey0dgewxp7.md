...
updated_at: 2026-07-10T07:36:55.216Z
---
...
Release gates: release commit merged to protected main; exact absent/same/conflict registry state machines; build once then privileged no-source/no-build publish jobs; enable and re-read GitHub immutable releases before publication; verify release/tag/assets; exact SBOM/attestation subjects; neutral-directory post-publish runtime/OS matrix; durable evidence record.
