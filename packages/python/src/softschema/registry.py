...
from softschema.models import SchemaBinding
...
class SchemaRegistry:
    ...
    def __init__(self) -> None:
        self._bindings: dict[str, SchemaBinding] = {}

    def register(self, binding: SchemaBinding) -> None:
    ...
    def resolve(self, contract_id: str) -> SchemaBinding | None:
