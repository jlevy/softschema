...
Version: v0.4 (last update 2026-05-11)\
...
This document is the standalone substrate referenced by repos that follow these
conventions.
For the full practical-writing system — principles, prescriptive guidelines,
scoring rubric, metrics, and tooling — see the
[Practical Prose](https://github.com/jlevy/practical-prose) repository.
